...
WORKSPACE_DIR=${WORKSPACE_DIR:-~/${CONTAINER_NAME:-upna_drone}_shared_volume}
echo "Container name: ${CONTAINER_NAME:-upna_drone}"
...
# Añadir el usuario ubuntu al grupo dialout para acceso a dispositivos seriales
